%% Question 1 part b. Analysis of thin plate using CPT elements
clc                                             %clears screeen
clear all                                       %clears workspace

%% Meshing
x=4;                                            %Number f nodes along x-axis
y=4;                                            %Number of nodes along y-axis
...
lx = 0.254/2;                                     %length of element in x-direction
ly = 0.254/2;                                     %ength of element in y-direction
P = 445;                                        %Point load
...
for i=1:ne                                      %Membrane stiffness
    ...
    Ke=kme+kbe;
    %Fe(63,1) = t*                                               le/2*[0; 0; Tx(i); 0; Tx(i); 0; 0; 0]; 
    for j=1:dofe
        for k=1:dofe
